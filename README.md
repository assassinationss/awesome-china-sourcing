...
### Systems for verifying Chinese suppliers, negotiating, and paying safely.
...
- [The Pro Edition](#-the-pro-edition)
...
- [How to Verify a Chinese Supplier in 2026](docs/how-to-verify-a-chinese-supplier-2026.md) - The six-step VERIFY system from first contact to wired deposit.
- [How to Read a Chinese Business License](docs/how-to-read-a-chinese-business-license.md) - Nine fields, line by line, plus the four-name cross-check that catches most fakes.
- [Alibaba vs 1688: Where Smart Importers Actually Buy](docs/alibaba-vs-1688-2026.md) - Prices, MOQs, and when the 30% gap inverts.
- [What Suppliers Say vs. What They Mean](docs/what-chinese-suppliers-say-vs-what-they-mean.md) - The bilingual decoder for 12 high-stakes phrases.
- [How to Pay a Chinese Supplier Safely](docs/how-to-pay-a-chinese-supplier-safely-2026.md) - The payment safety hierarchy and four scam patterns.
...
|-|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|
|1|**V**alidate the license |Business license ≠ trading company claim. Match the license name with the Alibaba company name — a mismatch means you're talking to a middleman. Full field-by-field decoding: see the business license guide|15 min |
...
Walk away (or investigate hard) when you see any of these:

1. Payment only via **personal account, Western Union, or crypto** — legitimate exporters have corporate USD/EUR accounts
2. Company name on the license **doesn't match** the name on Alibaba
3. Price is **30%+ below** every other quote for the same spec — you're being baited
4. "Our factory" + **refuses a live video walk-through** during working hours
5. Pushes you to **skip the sample** ("same as our other customers' orders")
...
- **Direct purchase**: email [assassinationss@163.com](mailto:assassinationss@163.com?subject=Playbook) with subject "Playbook" — payment details and same-day access to the pro repo. Free sample pack (2 AI prompts + the quality-claim template): email the same address with subject "Sample".

## 🤝 Contributing

Sourcing war story? Better red flag? Template that saved your order? PRs welcome — the best submissions get folded into the next edition with credit.
